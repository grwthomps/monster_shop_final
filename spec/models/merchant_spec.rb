...
describe Merchant, type: :model do
  ...
  describe 'instance methods' do
    before(:each) do
      ...
      @user_address = @user.addresses.create!(nickname: 'Home', street: '385 S. Rockledge Street', city: 'Denver', state: 'MA', zip: '01887')
      @user_1 = User.create!(name: "Ron Swanson", email: "test1@gmail.com", password: "password123", password_confirmation: "password123")
      @user1_address = @user.addresses.create!(nickname: 'Home', street: '385 S. Rockledge Street', city: 'Wilmington', state: 'MA', zip: '01887')
    end
    it 'no_orders' do
    ...
    it 'distinct_cities' do
      order_1 = Order.create!(user_id: @user.id, address_id: @user_address.id)
      order_2 = Order.create!(user_id: @user_1.id, address_id: @user1_address.id)
      order_3 = Order.create!(user_id: @user.id, address_id: @user_address.id)
      order_1.item_orders.create!(item: @tire, price: @tire.price, quantity: 2)
      order_2.item_orders.create!(item: @chain, price: @chain.price, quantity: 2)
      order_3.item_orders.create!(item: @tire, price: @tire.price, quantity: 2)

      expect(@meg.distinct_cities).to eq(['Denver', 'Wilmington']).or eq(['Wilmington', 'Denver'])
    end

    it 'pending_orders' do
      order_1 = Order.create!(user_id: @user.id, address_id: @user_address.id, status: 'cancelled')
      order_2 = Order.create!(user_id: @user_1.id, address_id: @user1_address.id)
      order_3 = Order.create!(user_id: @user.id, address_id: @user_address.id)
      order_1.item_orders.create!(item: @tire, price: @tire.price, quantity: 2)
      order_2.item_orders.create!(item: @chain, price: @chain.price, quantity: 2)
  ...
  describe 'class methods' do
    it 'can get all orders pertaining to a merchant' do
      ...
      user_1 = User.create(name: 'Kyle Pine', email: 'billybob@hotmail.com', password: 'reallysecurepassword', password_confirmation: 'reallysecurepassword')
      user1_address = user_1.addresses.create!(nickname: 'Home', street: '385 S. Rockledge Street', city: 'Wilmington', state: 'MA', zip: '01887')
      order_1 = user_1.orders.create(address_id: user1_address.id)
      order_1.item_orders.create(item_id: @tire.id, quantity: 2, price: 50)

      user_2 = User.create(name: 'Steve Spruce', email: 'snowsurferspruce@gmail.com', password: 'reallysecurepassword', password_confirmation: 'reallysecurepassword')
      user2_address = user_2.addresses.create!(nickname: 'Home', street: '385 S. Rockledge Street', city: 'Wilmington', state: 'MA', zip: '01887')
      order_2 = user_2.orders.create(address_id: user2_address.id)
      ...
      user_3 = User.create(name: 'Steve Spruce', email: 'snowsurferspruce1@gmail.com', password: 'reallysecurepassword', password_confirmation: 'reallysecurepassword')
      user3_address = user_3.addresses.create!(nickname: 'Home', street: '385 S. Rockledge Street', city: 'Wilmington', state: 'MA', zip: '01887')
      order_3 = user_3.orders.create(address_id: user3_address.id)
