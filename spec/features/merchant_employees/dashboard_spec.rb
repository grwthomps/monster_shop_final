...
RSpec.describe 'Merchant dashboard page for merchant employee' do
  before :each do
    @user = User.create!(name: "Andy Dwyer", email: "test1@gmail.com", password: "password123", password_confirmation: "password123")
    ...
    @order_1 = Order.create!(user_id: @user.id, address_id: @address.id)
    @order_2 = Order.create!(user_id: @user.id, address_id: @address.id)
    ...
    @employee = @mike.users.create!(name: "Andy Dwyer", email: "test@gmail.com", password: "password123", password_confirmation: "password123", role: 1)
