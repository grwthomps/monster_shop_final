...
RSpec.describe 'User login page' do
  ...
  describe 'merchant user' do
    before :each do
      ...
      @employee = @meg.users.create!(name: "Andy Dwyer", email: "test1@gmail.com", password: "password123", password_confirmation: "password123", role: 1)
      @admin = @meg.users.create!(name: "Ron Swanson", email: "test@gmail.com", password: "password123", password_confirmation: "password123", role: 2)
    end
