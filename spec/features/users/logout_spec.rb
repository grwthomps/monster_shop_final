...
RSpec.describe 'User logout' do
  ...
  describe 'merchant_employee' do
    before :each do
      ...
      @merchant_employee = @meg.users.create!(name: "Andy Dwyer", email: "test@gmail.com", password: "password123", password_confirmation: "password123", role: 1)
  ...
  describe 'merchant admin' do
    before :each do
      @meg = Merchant.create(name: "Meg's Bike Shop", address: '123 Bike Rd', city: 'Denver', state: 'CO', zip: 80203)
      @merchant_admin = @meg.users.create!(name: "Andy Dwyer", email: "test@gmail.com", password: "password123", password_confirmation: "password123", role: 2)
