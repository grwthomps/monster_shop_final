...
#---------------------------- Orders ----------------------------#
order_1 = cynthia.orders.create!(status: 3, address_id: 1)
...
order_2 = lynda.orders.create!(address_id: 4)
...
order_3 = cynthia.orders.create!(address_id: 2)
...
order_4 = lynda.orders.create!(status: 2, address_id: 3)
order_4.item_orders.create!(item_id: hibiscus.id, quantity: 4, price: hibiscus.price, status: 1)

order_5 = lynda.orders.create!(status: 0, address_id: 3)
...
order_6 = cynthia.orders.create!(address_id: 2)
